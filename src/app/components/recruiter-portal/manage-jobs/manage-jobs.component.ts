...
export class ManageJobsComponent implements OnInit {
  ...
  job_city: any;
  bill_rate: any;
  blended_pay_rate: any;
  at_holiday_rate: any;
  regular_pay_rate: any;
  position_type: any;
  job_type: any;
  job_sector: any;
  client_id: any;
  ...
  onOptionsSelected(value: string, name) {
  ...
  EditJob(val) {
    ...
    this.job_city = this.details.city;
    this.bill_rate = this.details.bill_rate;
  ...
  generateReport() {
    const reportUrl = `https://p3vw3hoyqd.execute-api.us-east-2.amazonaws.com/default/employeeApi-staging/vcsapi/api/generate/excel/manage/jobPost/${this.user_id}/${this.excelfileName}`;
