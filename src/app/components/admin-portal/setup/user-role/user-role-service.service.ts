...
export class UserRoleServiceService {
  ...
  addUserRole(details) {
    return this.http
      .post(
        "http://54.81.163.239:8000/vcsapi/add/api/tbl/role/user_role",
        details,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  updateUserRole(details) {
    return this.http
      .post(
        "http://54.81.163.239:8000/vcsapi/edit/api/change/role_name",
        details,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  changeStatusUserRole(details) {
    return this.http
      .post(
        "http://54.81.163.239:8000/vcsapi/edit/api/change/role_status",
        details,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getDefaultRoleData(details) {
    return this.http
      .post(
        "http://54.81.163.239:8000/vcsapi/get/api/module/accesses/by/role_id",
        details,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  postAccessRole(details) {
    return this.http
      .post(
        "http://54.81.163.239:8000/vcsapi/api/post/insert/role_id",
        details,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  duplicateRoleCheck(details) {
    return this.http
      .post("http://54.81.163.239:8000/vcsapi/api/check_post_role", details, {
        headers: this.header,
      })
      .pipe(retry(1), catchError(this.handleError));
  }
