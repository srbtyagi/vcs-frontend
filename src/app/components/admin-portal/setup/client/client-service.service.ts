...
export class ClientServiceService {
  ...
  getClientsDetails() {
    return this.http.get('http://3.12.123.49/vcsapi/get/all/clients', {headers: this.header})
      .pipe(
        retry(1),
  ...
  addClient(details) {
    return this.http.post('http://3.12.123.49/vcsapi/add/api/client/client_name', details, {headers: this.header})
      .pipe(
        retry(1),
        catchError(this.handleError)
      );
  ...
  updateClient(details) {
    return this.http.post('http://3.12.123.49/vcsapi/update/api/client_name', details, {headers: this.header})
      .pipe(
        retry(1),
        catchError(this.handleError)
      );
  ...
  changeStatusClient(details) {
    return this.http.post('http://3.12.123.49/vcsapi/edit/api/change_status/client', details, {headers: this.header})
      .pipe(
        retry(1),
        catchError(this.handleError)
      );
