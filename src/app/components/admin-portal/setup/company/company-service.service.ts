...
export class CompanyServiceService {
  ...
  getCompanyDetails() {
    return this.http.get('http://3.142.114.192:8000/vcsapi/get/api/tbl/company/details', {headers: this.header})
      .pipe(
        retry(1),
  ...
  updateCompanyDetails(details) {
    return this.http.post('http://3.142.114.192:8000/vcsapi/update/api/tbl/company/details', details, {headers: this.header})
      .pipe(
        retry(1),
        catchError(this.handleError)
      );
