...
export class DepartmentServiceService {
  ...
  getDepartmentDetails() {
    return this.http
      .get("https://api.vishusa.com:8000/vcsapi/get/api/department/byCID", {
        headers: this.header,
      })
  ...
  addDepartment(details) {
    return this.http
      .post("https://api.vishusa.com:8000/vcsapi/add/api/department", details, {
        headers: this.header,
      })
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  updateDepartment(details) {
    return this.http
      .post(
        "https://api.vishusa.com:8000/vcsapi/update/api/department_name",
        details,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  changeStatusDept(details) {
    return this.http
      .post(
        "https://api.vishusa.com:8000/vcsapi/edit/api/change_status/department",
        details,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
