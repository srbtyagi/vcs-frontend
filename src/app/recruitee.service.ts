...
export class RecruiteeService {
  ...
  token(datas) {
    ...
    return this.http
      .post(
        "http://localhost:8000/vcsapi/get_token",
        datas
      )
  ...
  login(datas) {
    ...
    return this.http
      .post(
        "http://localhost:8000/vcsapi/api/login/user",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  forgotPass(datas) {
    ...
    return this.http
      .post(
        "http://localhost:8000/vcsapi/api/forgot/user/password",
        datas
      )
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  check_email(datas) {
    ...
    return this.http
      .post(
        "http://localhost:8000/vcsapi/check/email",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  check_email_register(datas) {
    ...
    return this.http
      .post(
        "http://localhost:8000/vcsapi/check/email/register",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  check_email_old(datas) {
    ...
    return this.http
      .post(
        "http://localhost:8000/vcsapi/check/email/edit",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  check_old_password(datas) {
    ...
    return this.http
      .post(
        "http://localhost:8000/vcsapi/check/api/new/password",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  check_old_passcode(datas) {
    ...
    return this.http
      .post(
        "http://localhost:8000/vcsapi/check/api/new/passcode",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getUserById(id) {
    return this.http
      .post(
        "http://localhost:8000/vcsapi/get/api/users",
        id,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  check_resume(datas) {
    ...
    return this.http
      .post(
        "http://localhost:8000/vcsapi/check/resume",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getCurrentReqDocs(datas) {
    return this.http
      .get(
        `http://localhost:8000/vcsapi/get/required/doc/${datas}`,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  updateReqDocStatus(datas) {
    ...
    return this.http
      .post(
        "http://localhost:8000/vcsapi/update/req/doc/status",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  geAllSkillCategoryByuserId(datas) {
    ...
    return this.http
      .post(
        "http://localhost:8000/vcsapi/skilldata/by/user_id",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getJobDetailsById(id) {
    return this.http
      .post(
        "http://localhost:8000/vcsapi/get/api/tbl/job/by/id",
        id,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
