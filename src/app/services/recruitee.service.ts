...
export class RecruiteeService {
  ...
  register(datas, d1, d2) {
    ...
    return this.http
      .post(
        `http://3.142.114.192:8000/vcsapi/api/updateOrInsert/registration/user/${d1}/${d2}`,
        datas
      )
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  updateUserData(datas) {
    ...
    return this.http
      .post(
        `http://3.142.114.192:8000/vcsapi/update/api/rec_details/and/recudetails`,
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  uploadFileRegister(datas, d1, d2) {
    ...
    return this.http
      .post(
        `http://3.142.114.192:8000/vcsapi/upload/registration_api/resume/${d1}/${d2}`,
        datas,
  ...
  uploadFileRegisterGuest(datas, d1, d2, d3) {
    ...
    return this.http
      .post(
        `http://3.142.114.192:8000/vcsapi/upload/registration_api/resume/guest/${d1}/${d2}/${d3}`,
        datas,
        { reportProgress: true, observe: "events", headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  change_password(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/update/api/new/password/not/autogenerated",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  change_passcode(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/update/api/new/passcode/not/autogenerated",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getCandidateByUserId(id) {
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/get/api/candidate/by/userID",
        id,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getUserRecruiteeById(id) {
    return this.http
      .get(
        `http://3.142.114.192:8000/vcsapi/get/api/allrecruiteedetails/${id}`,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  add_applicant_guest(datas, exist) {
    ...
    return this.http
      .post(
        `http://3.142.114.192:8000/vcsapi/api/updateOrInsert/registration/user/application/guest/${exist}/${datas.user_id}`,
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  add_applicant_guest_By_email(datas) {
    ...
    return this.http
      .post(
        `http://3.142.114.192:8000/vcsapi/api/updateOrInsert/registration/user/application/guest/ByEmail`,
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  uploadDoc(datas, user, doc_id, doc_name, expiry_date) {
    ...
    return this.http
      .post(
        `http://3.142.114.192:8000/vcsapi/upload/document/${doc_name}/${user}/${doc_id}/${expiry_date}`,
        datas,
        {
          reportProgress: true,
          observe: "events",
  ...
  delete_temp_registration(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/delete/temp/registration",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getApplicationOnboard(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/get/application/onboarding/user",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getStandardDocDetails(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/api/get/standard/document/by/doc_id",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getStandardDocbyIdDetails(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/get/api/standard/docby/IDs",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getFacilityDocbyNameDetails(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/get/api/facility/doc/byname",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getOthersDocbyNameDetails(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/get/api/other/doc/byname",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getdocBydoc_name(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/get/doc_id/other/or/facility",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  updateFillup(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/update/fillup/status/done",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getAssignmentDetails(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/api/get/payroll/assignment",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getAssignmentPayrollDetails(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/get/assignmentdata/assignment_history/filtered",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getJobIdDetails(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/api/get/job_no/assignment_id/and/job_id",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getWorkDetails(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/api/get/tbl_week/week_id/not/in/tbl_rec_work_hr",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  insertWorkHour(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/api/insert/tbl_rec_work_hr",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getAssignmentDataByapplication(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/get/api/payroll_status/approved/assgnmnt_status/workingORclosed/by/applID",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  geAllJobCategory_Area() {
    return this.http
      .get(
        "http://3.142.114.192:8000/vcsapi/get/api/skill_area/byall/activecatID",
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  }
  ...
  geAllJobDomain_skillset(datas) {
    ...
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/get/api/skill_domain/skillset/by/skill_area_id",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  getAlreadyAppliedStatusByEmail(datas) {
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/get/user/already/applied/job/ByEmail",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
  ...
  insertCandidate(datas) {
    return this.http
      .post(
        "http://3.142.114.192:8000/vcsapi/insert/api/canditate/skillset_map/data",
        datas,
        { headers: this.header }
      )
      .pipe(retry(1), catchError(this.handleError));
