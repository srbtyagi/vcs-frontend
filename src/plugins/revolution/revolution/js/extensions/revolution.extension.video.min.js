...
!(function (e) {
  ...
  jQuery.extend(!0, a, {
    ...
    resetVideo: function (e, o, d) {
      ...
      switch (n.videotype) {
        case "youtube":
          ...
          try {
            if ("on" == n.forcerewind) {
              (p = t(e.data("videostartat"))),
                1 === n.bgvideo || e.find(".tp-videoposter").length;
              void 0 != n.player &&
                ((p = -1 == p ? 0 : p),
                n.player.seekTo(p),
                n.player.pauseVideo());
        ...
        case "html5":
          ...
          var s = "html5" == n.audio ? "audio" : "video",
            l = e.find(s),
            u = l[0];
          if (
      ...
      switch (o.videotype) {
        case "youtube":
          if (0 == e.find("iframe").length)
            e.append(e.data("videomarkup")), r(e, i, !0);
    ...
    manageVideoLayer: function (e, n, s, l) {
      ...
      var p = e.data(),
        ...
        m =
          "auto" === p.videopreload ||
          "canplay" === p.videopreload ||
          "canplaythrough" === p.videopreload ||
          "progress" === p.videopreload
            ? "auto"
            : p.videopreload,
        f = p.videomp4,
        y = p.videowebm,
        ...
        k =
          "loop" == p.videoloop
            ? "loop"
            : "loopandnoslidestop" == p.videoloop
            ? "loop"
            : "",
        x =
          void 0 != f || void 0 != y
      ...
      switch (((k = !0 === p.nextslideatend ? "" : k), (p.videotype = x), V)) {
        case "html5":
          ...
          var P = "";
          a.is_mobile() &&
            ("on" === p.autoplay || "true" === p.autoplay || !0 === p.autoplay
              ? (P = "muted playsinline autoplay")
              : (1 != p.videoinline &&
                  "true" !== p.videoinline &&
                  1 !== p.videoinline) ||
                (P += " playsinline"));
          var I =
            ...
            m +
            '">';
          "auto" == m && (n.mediapreload = !0),
            void 0 != y &&
              "firefox" == a.get_browser().toLowerCase() &&
              (I = I + '<source src="' + y + '" type="video/webm" />'),
            void 0 != f &&
              (I = I + '<source src="' + f + '" type="video/mp4" />'),
            void 0 != h &&
              (I = I + '<source src="' + h + '" type="video/ogg" />'),
            (I = I + "</" + L + ">");
          var C = "";
          ("true" !== b && !0 !== b) ||
            (C =
        ...
        case "youtube":
          (T = "https"),
            ...
            (!0 !== p.videoinline &&
              ...
              1 !== p.videoinline) ||
              (v += "&playsinline=1");
          var j = t(e.data("videostartat")),
            _ = t(e.data("videoendat"));
          -1 != j && (v = v + "&start=" + j), -1 != _ && (v = v + "&end=" + _);
          var A = v.split("origin=" + T + "://"),
            S = "";
          A.length > 1
            ? ((S = A[0] + "origin=" + T + "://"),
      ...
      if (void 0 != p.videoposter && p.videoposter.length > 2 && !Q)
        0 == e.find(".tp-videoposter").length &&
          e.append(
        ...
        0 != e.find("iframe").length ||
          ("youtube" != x && "vimeo" != x) ||
          (e.append(e.data("videomarkup")), r(e, n, !1));
      }
  ...
  var d = function (e, t, a) {
    ...
    r = function (e, o, d) {
      ...
      if (
        ((g = "loop" == g || "loopandnoslidestop" == g),
        1 == e.data("forcecover") &&
          (e.removeClass("fullscreenvideo").addClass("coverscreenvideo"),
          void 0 != (f = e.data("aspectratio")) &&
            f.split(":").length > 1 &&
            (console.log("i"), a.prepareCoveredVideo(f, o, e))),
        1 == e.data("bgvideo"))
      ) {
        var f = e.data("aspectratio");
        void 0 != f &&
          f.split(":").length > 1 &&
          (console.log("ak"), a.prepareCoveredVideo(f, o, e));
      }
      if (
        (u.attr("id", c),
              ...
              events: {
                onStateChange: function (i) {
                  var d = e.closest(".tp-simpleresponsive"),
                    u = (r.videorate, e.data("videostart"), l());
                  if (i.data == YT.PlayerState.PLAYING)
                    punchgs.TweenLite.to(e.find(".tp-videoposter"), 0.3, {
                      ...
                      !0 === o.globalmute
                        ? k.mute()
                        : (k.unMute(),
                          k.setVolume(parseInt(e.data("volume"), 0) || 75)),
                      (o.videoplaying = !0),
                      p(e, o),
                      m ? o.c.trigger("stoptimer") : (o.videoplaying = !1),
                      o.c.trigger(
                        "revolution.slide.onvideoplay",
                        n(k, "youtube", e.data())
                      ),
                      a.toggleState(r.videotoggledby);
                  else {
                    if (0 == i.data && g) {
                      ...
                      -1 != i.data &&
                        ...
                        (void 0 != o.currentLayerVideoIsPlaying &&
                          o.currentLayerVideoIsPlaying.attr("id") !=
                            e.attr("id")) ||
                          a.unToggleState(r.videotoggledby)),
    ...
    u = function (e, o, r) {
      ...
      var u = e.data(),
        ...
        f = g.parent(),
        y = u.videoloop,
        h = "loopandnoslidestop" != y;
      if (
        ((y = "loop" == y || "loopandnoslidestop" == y),
        f.data("metaloaded", 1),
        1 != e.data("bgvideo") ||
          ("none" !== u.videoloop && !1 !== u.videoloop) ||
          (h = !1),
      ...
      void 0 != w &&
        ...
        d(m, "play", function () {
          ...
          p(e, o),
            h && "audio" != i
              ? ((o.videoplaying = !0),
                ...
                o.c.trigger("revolution.slide.onvideoplay", n(m, "html5", u)))
              : ((o.videoplaying = !1),
                "audio" != i && o.c.trigger("starttimer"),
                o.c.trigger("revolution.slide.onvideostop", n(m, "html5", u))),
            punchgs.TweenLite.to(e.find(".tp-videoposter"), 0.3, {
              autoAlpha: 0,
              force3D: "auto",
              ease: punchgs.Power3.easeInOut,
          ...
          var d = e.find(".tp-vid-play-pause")[0],
            r = e.find(".tp-vid-mute")[0];
          void 0 != d && (d.innerHTML = "Pause"),
            void 0 != r && m.muted && (r.innerHTML = "Unmute"),
            a.toggleState(u.videotoggledby);
        }),
        d(m, "pause", function (t) {
          ...
          void 0 != d && (d.innerHTML = "Play"),
            (void 0 != o.currentLayerVideoIsPlaying &&
              ...
              a.unToggleState(u.videotoggledby);
        }),
        d(m, "ended", function () {
          s(),
            v(e, o),
            (o.videoplaying = !1),
            v(e, o),
            "audio" != c && o.c.trigger("starttimer"),
            o.c.trigger(
              "revolution.slide.onvideostop",
              n(m, "html5", e.data())
            ),
