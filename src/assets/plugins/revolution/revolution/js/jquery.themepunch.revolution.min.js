  ...
  jQuery.extend(!0, _R, {
    ...
    setSize: function (e) {
      ...
      e.c
        ...
        .css(u),
        e.c.closest(".rev_slider_wrapper").css(u),
        setScale(e);
    },
          ...
          e.find(".tp-caption, .rs-background-video-layer").each(function (e) {
              ...
              "row" !== m && "group" !== m && "column" !== m
                ? ((b = "display:" + t.css("display") + ";"),
                  t.closest(".rev_column").length > 0
                    ? (t.addClass("rev_layer_in_column"), (d = !1))
                    : t.closest(".rev_group").length > 0 &&
                      (t.addClass("rev_layer_in_group"), (d = !1)))
                : "column" === m && (d = !1),
                g.wrapper_class !== undefined &&
                  (w = w + " " + g.wrapper_class),
            ...
            R !== undefined && _R.checkActions(t, i, R),
              ...
              !_ISM ||
                ...
                ((1 != n && "true" != n) ||
                  ((a.autoplayonlyfirsttime = !1), (n = !1)),
                (1 != r && "true" != r && "on" != r && "1sttime" != r) ||
                  ((a.autoplay = "off"), (r = "off"))),
              s ||
                (1 != n && "true" != n && "1sttime" != r) ||
                "loopandnoslidestop" == l ||
                t
