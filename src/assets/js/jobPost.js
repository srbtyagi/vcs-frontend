...
fetch(
  ...
  .then((json) => {
    ...
    for (var i = 0; i < allArray.length; i++) {
      ...
      var findValidDate = new Date(details.job_post_date)
        .toLocaleDateString("en-CA")
        .split("-");
      var finalDate =
        "" +
        (parseInt(findValidDate[0]) + 1) +
        "-" +
        findValidDate[1] +
        "-" +
        findValidDate[2];
      const json = {
        ...
        url:
          "http://3.95.196.197:8000/job-details?special=" +
          details.job_id +
          "",
        ...
        datePosted:
          new Date(details.job_post_date).toLocaleDateString("en-CA") +
          "T00:00:00",
